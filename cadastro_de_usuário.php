    ...
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="margin: 0px;">
                ...
                <form action="inserir_usuario.php" metod="post">
                    <!-- Start: 2-column form row -->
                    <div class="form-row" style="height: 78px;">
                        <div class="col-10 col-sm-6 col-xl-3 offset-1 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control" name="nome" type="text" placeholder="Nome" required=""></div>
                        </div>
                        <div class="col-10 col-sm-6 col-xl-3 offset-1 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control" name="sobrenome" type="text" placeholder="Sobrenome" required=""></div>
                        </div>
                        <div class="col-xl-2 offset-xl-1"><input class="form-control" name="Usuário AD" type="text" placeholder="Usuário AD" inputmode="tel" required="" style="margin-top: 24px;"></div>
                        <div class="w-100"></div>
                        <div class="w-100"></div>
                    </div><!-- End: 2-column form row -->
                    <!-- Start: 3-column form row -->
                    <div class="form-row">
                        <div class="col-sm-4 offset-lg-1 offset-xl-1"><input class="form-control" name="Função" type="Função" placeholder="Função" required="" style="padding: 6px;margin-top: 24px;"></div>
                        <div class="col-xl-3">
                    ...
                    <div class="form-row" style="height: 108px;">
                        <div class="col-sm-2 col-xl-4 offset-xl-1">
                            <div class="form-group"><label></label><input class="form-control"  name="password" type="password" placeholder="Senha"></div>
                        </div>
                        <div class="col-sm-2 col-xl-4 offset-xl-2">
                            <div class="form-group"><label></label><input class="form-control"  name="confirmaPassword" type="password" placeholder="Confirmação de Senha"></div>
                        </div>
                    ...
                    <div class="form-row" style="margin-top: 50px;">
                        <div class="col-lg-4 col-xl-4 offset-lg-4 offset-xl-4" style="border-radius: 15px;"><button class="btn btn-success btn-block active text-white pulse animated btn-user" type="submit" style="background: rgb(44,64,74);border-radius: 10px;padding: 30px, 30px;border-width: 0px;height: 50px;">Cadastrar</button></div>
